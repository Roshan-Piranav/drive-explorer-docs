...
1. Select attributes like file name, preview, URL, download link, file ID, MIME type, and size.
2. Insert data at the selected cell or append below existing content.
3. Use the built-in Google Drive file picker for intuitive file selection.
